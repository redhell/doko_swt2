...
public class Card implements Comparable {
	...
	public int compareTo(Object o) {
		...
		} else {//Vergleich des Symbols bei nicht-Trumpf n�tig? Man muss sowieso die richtige Farbe bedienen, ansonsten ist es weniger Wert. Irgendwo muss noch die erste gespielte Farbe abgespeichert werden
					if(this.wertigkeit.compareTo(c.wertigkeit) < 0) {
						return -1;
					} else if(this.wertigkeit.compareTo(c.wertigkeit) > 0) {
						return 1;
