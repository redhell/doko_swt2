...
public class LoginButtonHandler implements EventHandler<ActionEvent> {
	...
	public LoginButtonHandler(Gui gui, TextField username_field, PasswordField password_field, Label login_failed_label) {
		this.gui = gui;
	...
	public void handle(ActionEvent event) {
		...
		login_credentials.put(JSONAttributesE.USERNAME.name(), username_field.getText());
		login_credentials.put(JSONAttributesE.PASSWORD.name(), password_field.getText());
		...
		if(login_successful){
			...
			login_failed_label.setText("wrong credentials");
		}
